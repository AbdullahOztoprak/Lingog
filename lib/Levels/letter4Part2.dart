...
class Letter4Part2 extends StatefulWidget {
  final int wordLength; // ✅ Kelime uzunluğu

  const Letter4Part2({super.key, required this.wordLength});

  @override
  State<Letter4Part2> createState() => _Letter4Part2State();
}

class _Letter4Part2State extends State<Letter4Part2> {
  late String _word;
