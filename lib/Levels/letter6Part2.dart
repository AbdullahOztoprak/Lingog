...
class Letter6Part2 extends StatefulWidget {
  final int wordLength; // ✅ Kelime uzunluğu

  const Letter6Part2({super.key, required this.wordLength});

  @override
  State<Letter6Part2> createState() => _Letter6Part2State();
}

class _Letter6Part2State extends State<Letter6Part2> {
  late String _word;
