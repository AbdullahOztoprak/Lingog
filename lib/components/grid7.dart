...
class Grid7 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<Controller>(builder: (_, notifier, __) {
      ...
      double spacing =
          screenWidth * 0.014; // 📏 Boşlukları dinamik yap (1.5% genişlik)
      double gridPadding =
          screenWidth * 0.001; // 📏 Kenar boşluğu (2% genişlik)
      ...
      return Padding(
        ...
        child: GridView.builder(
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            ...
            childAspectRatio: 0.85, // ✅ Kare oranını koru
          ),
